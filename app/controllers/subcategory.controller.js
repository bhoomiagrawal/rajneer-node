...
exports.getAll = async (req, res) => {
    try {
        ...
        // Calculate total pages (if no records are found, total pages is 0)
        const totalPages = subcategoryList.count > 0 ? Math.ceil(subcategoryList.count / perPage) : 0;
        ...
        return sendResponse({
            ...
            // }
            // data: {
            //     subCategory: subcategoryList.rows,  // Rename rows to subCategory data
            //     count: subcategoryList.count,   // Include the total count for pagination
            //     totalPages: Math.ceil(subcategoryList.count / perPage), // Calculate total pages
